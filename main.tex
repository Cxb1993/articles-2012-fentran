...
\begin{itemize}
	\item Bolhas dispersas ou \emph{Bubbly flow}: no escoamento em
	...
	em golfadas.
	\item Golfadas ou \emph{Slug flow}: neste tipo de escoamento, as
...
\begin{itemize}
	\item Bolhas dispersas ou \emph{Bubble flow}:
	\item \emph{Plug flow}:
	\item Estratificado ou \emph{Stratified}:
	\item Estratificado ondulado ou \emph{Wavy}:
	\item Anular ou \emph{Annular}:
\end{itemize}
