...
\graphicspath{{./figs/}{./figs/pdf/}}  % onde encontrar as figuras...
...
qual sua estrutura f\'isica e em sua composi\c c\~ao qu\'imica s\~ao
...
\begin{figure}[h!]
	\begin{center}
		...
		{\includegraphics[angle=00, scale=0.3]{surfTension1.pdf}
		\hspace{0.4cm}}
		\subfloat[gotas em repouso]
		{\includegraphics[angle=00, scale=0.3]{surfTension2.pdf}
		\hspace{0.4cm}}
		\subfloat[capilaridade]
		{\includegraphics[angle=00, scale=0.3]{surfTension3.pdf}}
	\end{center}
	\caption{}
...
modelo de um fluid (one-fluid), as equa\c c\~oes que modelam o
...
da equa\c c\~ao de conserva\c c\~ao de quantidade de movimento
(referencia para capitulo do Pontes). Este cap\'itulo focar\'a sua
introdu\c c\~ao no modelo de um fluido. Uma vez que a dedu\c c\~ao das
equa\c c\~oes de conserva\c c\~ao para escoamentos monof\'asicos se
encontra no volume 1 deste livro, tomamos a liberdade de apresentar
estas equa\c c\~oes, aplicadas a escoamentos bif\'asicos, em sua forma
euleriana vetorial, para o modelo de um fluido.
...
de difusao num\'erica e deve ser tratada com aten\c c\~ao. Neste tipo de
...
\begin{figure}[ht!]
	...
	\caption{Representa\c c\~ao da inteface em escoamentos bif\'asicos. (a)
	Na descri\c c\~ao \emph{Euleriana}, a interface entre os fluidos \'e
	definda em uma posi\c c\~ao arbitr\'aria em rela\c c\~ao aos elementos.
	Diferentemente, (b) o descri\c c\~ao \emph{Lagrangiana} representa a
	interface atrav\'es de pontos pertencentes \`a malha computacional
	atrav\'es da defini\c c\~ao de objectos, tais quais n\'os, segmentos e
	elementos, obtendo assim uma representa\c c\~ao precisa da interface.}
	\label{fig:interface} 
\end{figure}
...
\begin{figure}[ht!]
	...
	\caption{Representa\c c\~ao da interface no m\'etodo \emph{VOF}. (a) A
	interface entre os fluidos \'e definida implicitamente e localizada
	em algum lugar entre elementos computacionais. (b) A fun\c c\~ao
...
grande diferen\c ca na rela\c c\~ao de desidades. O modelo de for\c ca de
...
simula\c c\~ao de escolamentos bif\'asicos atrav\'es do m\'etodo \emph{VOF}.
...
superficial \'e realizada com sucesso. Apesas de sua recente apari\c
...
upwind/proje\c c\~ao para o c\'alculo da solu\c c\~ao das equa\c c\~oes
de Navier-Stokes para fluidos imisc\'iveis. Foi mostrado que a
conserva\c c\~ao de mass \'e apenas garantida se a fun\c c\~ao de
Level-Set \'e reinicializada preferenciamente em todo passo de tempo.
Eles realizaram significativos testes com bolhas e gotas para valida\c
c\~ao desta nova metodologia. Adicionalemente, \cite{sussman1997}
...
de quantidade de movimento. Coalescencia e ascen\c c\~ao  de bolhas
...
primeiro utiliza particulas marcadoras para reconstru\c c\~ao da interface,
...
de um m\'etodo de passo fracional exato. Tal t\'ecnica melhora a
...
t\'itulo de vapor aumentar\'a na dire\c c\~ao do escomaento. No
entando, para o caso de resfriamento do tubo e, consequentemente, a
...
escoamento multif\'asico est\'a localizado. Atrav\'es da absorv\c c\~ao de
...
quantidade de gas e l\'iquido diretamente. Esta fra\c c\~ao \'e ent\~ao
definda como:
...
\begin{figure}[h!]
	\begin{center}
		...
		\hspace{0.4cm}}
		\subfloat[batido (\emph{churn})]
		{\includegraphics[angle=00, scale=0.3]{v_churn.pdf}
		\hspace{0.4cm}}
		\subfloat[pouco-anular (\emph{wispy-annular})]
...
\begin{itemize}
	...
	em uma distribui\c c\~ao ca\'otica. Nele, a fase l\'iquida \'e impurrada
...
\begin{figure}[ht!]
	...
	(\cite{hewitt1969}). As linhas tracejadas representam a transi\c c\~ao
...
\begin{figure}[ht!]
	...
	transi\c c\~ao dos padr\~oes de escoamento.}
	\label{fig:map2} 
\end{figure}
