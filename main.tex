...
A proposta deste cap\'itulo \'e de dar ao leitor uma vis\~ao geral dos
...
autores que desenvolvem metodologias para a investiga\cao deste
...
aplicadas ao escoamento bif\'asico, em sua forma euleriana vetorial
final, para o modelo de um fluido (one-fluid).
...
que no segundo o referencial movimenta com a velocidade fluido. Estes
...
Em escoamentos bif\'asicos, \emph{two-phase flows} em ingl\^es, a
...
sigla em ingl\^es) foi proposto por \cite{}, no qual consiste na
