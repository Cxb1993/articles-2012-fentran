...
primeiro exemplo podemos observar a presen\c ca de uma for\c ca capaz de
equilibrar a esfera sobre a coluna de l\'iquido. Para o caso
representado, onde o somat\'orio das for\c cas \'e nulo, a grandeza
respons\'avel pela sustenta\c c\~ao da esfera se chama tens\~ao
superficial. Este efeito f\'isico aparece na camada superficial do
l\'iquido e age como uma membrana el\'astica. A tens\~ao superficial
depende do sistema bif\'asico e pode variar conforme as propriedades
f\'isicas dos fluidos, a temperatura ou, ainda, com a contamina\c c\~ao
dos fluidos. No segundo exemplo s\~ao ilustradas duas gotas em repouso.
Na figura pode-se observar que o contato do l\'iquido com uma
superf\'icie s\'olida pode variar a forma da gota. Esta diferen\c ca de
forma \'e atribuida ao tipo de superf\'ice em contato com o fluido. As
...
esf\'erica. O terceiro exemplo representa o fen\^omeno de capilaridade
...
abaulamento do l\'iquido junto \`a superf\'icie do copo.

\begin{figure}[h!]
	\begin{center}
		\subfloat[esfera em repouso]
		{\includegraphics[angle=00, scale=0.3]{surfTension1.eps}
		\hspace{0.4cm}}
		\subfloat[hidrof\'ilica]
		{\includegraphics[angle=00, scale=0.3]{surfTension2.eps}
		\hspace{0.4cm}}
		\subfloat[capilaridade]
		{\includegraphics[angle=00, scale=0.3]{surfTension3.eps}}
	\end{center}
	...
	zero pois o peso da esfera \'e correspondido pelo efeito da tens\~ao
	superficial do l\'iquido. (b) Em uma superf\'icie hidrof\'ilica, a
	gota tende a se espalhar, enquanto em uma (c) superf\'icie
	hidrof\'obica, a gota tende a ficar concentrada em uma \'area de
	contato menor. (d) Efeitos de capilaridade fazem o l\'iquido subir
...
\begin{figure}[ht!]
	...
	\caption{Representa\c c\~ao da interface em escoamentos bif\'asicos. (a)
	Na descri\c c\~ao \emph{Euleriana}, a interface entre os fluidos \'e
	definida em uma posi\c c\~ao arbitr\'aria em rela\c c\~ao aos elementos.
...
\begin{figure}[h!]
	...
	\end{center}
	\caption{Escoamentos bif\'asicos em tubos verticais. Em todos os
	casos o escoamento se faz de baixo para a cima. Os efeitos
	gravitacionais s\~ao uniformes ao longo do eixo horizontal, fazendo
	com que o escoamento apresente alguma estrutura sim\'etrica.}
	\label{fig:vertical} 
\end{figure}
...
% 	casos o escoamento se faz de baixo para a cima. Os efeitos
% 	gravitacionais s\~ao uniformes ao longo do eixo horizontal, fazendo
% 	com que o escoamento apresente alguma estrutura sim\'etrica. (a) Bolhas 
% 	(\emph{Bubbly}), (b) Golfada (\emph{Slug}), (c) Batido
% 	(\emph{Churn}), (d) Pouco anular (\emph{Wispy-annular}) e (e) Anular
% 	(\emph{Annular}). }
% 	\label{fig:vertical} 
% \end{figure}
%-------------------------------------------------- 
...
% 		\hspace{0.8cm}}
	...
	\end{center}
	\caption{Escoamentos bif\'asicos em tubos horizontais. Em todos os
	casos o escoamento se faz da esquerda para a direta. Dependendo da
	velocidade de entrada das fases, um padr\~ao pode ser identificado.
	Como pode ser verificado pela posi\c c\~ao das bolhas, a gravidade
	exerce uma influ\^encia imediata nas fases, uma vez que o fluido
	menos denso tende a se movimentar na parte de cima do tubo.}
...
\begin{figure}[ht!]
	...
	\caption{Mapas de padr\~oes de escoamento bif\'asico. As linhas
	cont\'inuas e tracejadas representam a transi\c c\~ao
	dos padr\~oes de escoamento. (a) Escoamento vertical para ar/\'agua
