...
identifica\cao do tipo de escoamento (golfadas, anular, estratificado
etc.) atrav\'es de par\^ametros conhecidos como vaz\~ao m\'assica,
fra\cao de vazios, qualidade de vapor etc. Estes mapas existem para
diferentes tipos de fluidos, dimens\~ao de tubos, graus de mistura e
muitos outros. Basicamente, eles podem ser dividos em duas classes:
...
refrigerantes em evapora\cao. 

Os mapas de padr\~oes s\~ao representados como \'areas em gr\'aficos, em
fun\cao das velocidades superficiais ou qualquer outro par\^ametro geral
que contenha tal defini\cao . \'E importante notar que o padr\~ao de
escoamento \'e tamb\'em influenciado por outros tipos de par\^ametros,
por\'em sua descri\cao atrav\'es de gr\'aficos bi-dimensionais. Na
...
A Fig.~(\ref{fig:map1}) representa um mapa de padr\~oes de escoamento
...
tracejadas delimitam a transi\cao.  Como pode-se observar tamb\'em,
...
A Fig.~(\ref{fig:map2}) descreve um outro mapa de padr\~oes, por\'em
...
\begin{figure}[ht!]
	\includegraphics[scale=0.5,angle=-0.2]{hewitt1969.pdf}
	\caption{Mapa de padr\~oes de escoamento vertical para ar/\'agua
	(\cite{hewitt1969}). As linhas tracejadas representam a transi\cao
	dos padr\~oes de escoamento.}
	\label{fig:map1} 
\end{figure}

\begin{figure}[ht!]
	\includegraphics[scale=0.5,angle=1.1]{baker1954.pdf}
	\caption{Mapa de padr\~oes de escoamento horizontal para ar/\'agua
	(\cite{baker1954}). As linhas cont\'inuas e tracejadas representam a
	transi\cao dos padr\~oes de escoamento.}
	\label{fig:map2} 
\end{figure}
